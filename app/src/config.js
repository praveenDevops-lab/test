...
module.exports = {
    ...
    ngrok: {
        ...
        */
        authToken: '2QxY3n0a7iNBHwdDKHlFikyoc8x_7kC24d7BuLiGZcsepan3C',
    },
    api: {
        // app/api
    ...
    mediasoup: {
        ...
        webRtcTransport: {
            listenIps: [
                {
                    ip: '0.0.0.0',
                    announcedIp: '52.74.166.77', // replace by 'public static IPV4 address' https://api.ipify.org (type string --> 'xx.xxx.xxx.xx' not xx.xxx.xxx.xx)
